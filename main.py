...
if 'uploaded_file' in st.session_state:
        ...
        #plots -----------------------------------------------------------------------------------------------------------------------------------------
        with st.container():
                st.write("**Precision and Recall with various thresholds alongside the Receiver-Operating characteristic Curve (ROC) and Area Under Curve (AUC)**")
                #st.write("**Receiver-Operating characteristic Curve (ROC) and Area Under Curve (AUC)**")
                ...
                st.divider()
        with st.container():
            st.write("**Log odds for the coefficients and Information Value for features**")
            ...
            with col1:
                ...
                colors = ['yellow' if x < 0 else 'green' for x in coef_df.iloc[:size]['Coefficient']]
        ...
        with st.container():
            ...
            with col2:
                ...
                ax.set_title("Certainty Histogram", fontsize=13,fontweight='bold')
